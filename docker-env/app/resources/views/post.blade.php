...
@section('content')
    <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-outline-primary" role="button" href="{{route('recipe_edit',['recipe'=>$recipes[0]['id']])}}">編集</a>
                <a class="btn btn-outline-primary" role="button" href="{{route('recipe_delete',['recipe'=>$recipes[0]['id']])}}">削除</a>
                @else
                    <a href="{{route('page',['user'=>$recipes[0]['user_id']])}}">
                    ...
                    <a href="{{route('page',['user'=>$recipes[0]['user_id']])}}">{{$recipes[0]['user']['name']}}</a>
